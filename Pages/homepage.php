...
<html>
    <head>
        ...
        <title>Humor Competition - Home</title>
        <script src="http://code.jquery.com/jquery-latest.js"></script>
        <script src="js/submit.js"></script>
    </head>
    <body>
        <header>
        <h1 id="title">Humor Competition</h1>
        <h4 class="logsign">
            <?php
            session_start();
		...
		<main>
			...
			<div id="jokes-container">
                    ...
                    <?php
                        ...
                        $star=0;
                        $pos=0;
                        $result=mysqli_query($dbconn, "SELECT j.id_joke,email , title, text_joke,CAST(AVG(vote)as decimal (10,1)) as avg FROM users u inner join (jokes j left join votes v on j.id_joke=v.id_joke) on u.id_user=j.id_user where shows=true group by email order by rand()  limit 10;");
